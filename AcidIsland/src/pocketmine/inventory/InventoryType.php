...
class InventoryType {
	...
	public static function init(){
		...
		static::$default = [
			static::CHEST => new InventoryType(25, "Chest", InventoryNetworkIds::CONTAINER),
			static::DOUBLE_CHEST => new InventoryType(25 + 25, "Double Chest", InventoryNetworkIds::CONTAINER),
			static::PLAYER => new InventoryType(37, "Player", InventoryNetworkIds::INVENTORY), //36 CONTAINER, 4 ARMOR
			...
			static::DISPENSER => new InventoryType(9, "Dispenser", InventoryNetworkIds::INVENTORY), //9 CONTAINER
			static::DROPPER => new InventoryType(9, "Dropper", InventoryNetworkIds::INVENTORY), //9 CONTAINER
			static::HOPPER => new InventoryType(5, "Hopper", InventoryNetworkIds::INVENTORY), //5 CONTAINER
