...
class Server{
	...
	public function getiTXApiVersion(){
		return \pocketmine\TERMINATORVN_API_VERSION;
	}

	/**
	 * @return string
	 */
	public function getTmntApiVersion(){
		return \pocketmine\TERMINATORVN_API_VERSION;
	}
	...
	public function about(){
	 $version = implode(",",ProtocolInfo::MINECRAFT_VERSION);
		$string = "
§1┌§2─§3─§4─§5─§6─§7─§8─§9─§r─§a─§e─§c─§d─§b─§f─§1─§2─§3─§4─§5─§6─§7─§8─§9─§r─§a─§e─§c─§d─§b─§f─§1─§2─§3─§4─§5─§6─§7─§8─§9─§r─§a─§e─§c─§d─§b─§f─§1─§2─§3─§4─§5─§6─§7─§8─§9─§r─§a─§e─§c─§d─§b─§f─§1─§2─§3─§4─§5─§6─§7─§8─§9─§r─§a─§e─§d─§b─§f─§1─§2┐		
§2│§b•=»§d _______                  _             _          §c__      __§e_   _          §2│
§3│§b•=»§d|__   __|                (_)           | |         §c\ \    / /§e \ | |         §3│
§4│§b•=»§d   | | ___ _ __ _ __ ___  _ _ __   __ _| |_ ___  _ _§c\ \  / /§e|  \| |         §4│
§5│§b•=»§d   | |/ _ \ '__| '_ ` _ \| | '_ \ / _` | __/ _ \| '__§c\ \/ / §e| . ` |         §5│
§4│§b•=»§d   | |  __/ |  | | | | | | | | | | (_| | || (_) | |   §c\  /  §e| |\  |         §4│
§3│§b•=»§d   |_|\___|_|  |_| |_| |_|_|_| |_|\__,_|\__\___/|_|    §c\/   §e|_| \_|         §3│
§2│§b•=»§9 Nếu Có Lỗi Hãy Lên Báo Cho: fb.com/dev.terminatorvn			§2│
§1└§2─§3─§4─§5─§6─§7─§8─§9─§r─§a─§e─§c─§d─§b─§f─§1─§2─§3─§4─§5─§6─§7─§8─§9─§r─§a─§e─§c─§d─§b─§f─§1─§2─§3─§4─§5─§6─§7─§8─§9─§r─§a─§e─§c─§d─§b─§f─§1─§2─§3─§4─§5─§6─§7─§8─§9─§r─§a─§e─§c─§d─§b─§f─§1─§2─§3─§4─§5─§6─§7─§8─§9─§r─§a─§e─§d─§b─§f─§1─§2┘
";
	...
	public function loadAdvancedConfig(){
		...
		$this->keepInventory = $this->getAdvancedProperty("player.keep-inventory", true);
		$this->keepExperience = $this->getAdvancedProperty("player.keep-experience", true);
	...
	public function __construct(\ClassLoader $autoloader, \ThreadedLogger $logger, $filePath, $dataPath, $pluginPath, $defaultLang = "unknown"){
		...
		try{
			...
			if(file_exists($this->filePath . "src/pocketmine/resources/terminatorvn_$lang.yml")){
				$content = file_get_contents($file = $this->filePath . "src/pocketmine/resources/terminatorvn_$lang.yml");
			}else{
				$content = file_get_contents($file = $this->filePath . "src/pocketmine/resources/terminatorvn_eng.yml");
			}

			if(!file_exists($this->dataPath . "terminatorvn.yml")){
				@file_put_contents($this->dataPath . "terminatorvn.yml", $content);
			}
			$internelConfig = new Config($file, Config::YAML, []);
			$this->advancedConfig = new Config($this->dataPath . "terminatorvn.yml", Config::YAML, []);
			...
			if($cfgVer > $advVer){
				$this->logger->notice("Your terminatorvn.yml needs update");
	...
	public function start(){
		...
		if(!file_exists($this->getPluginPath() . DIRECTORY_SEPARATOR . "TerminatorVN"))
			@mkdir($this->getPluginPath() . DIRECTORY_SEPARATOR . "TerminatorVN");
