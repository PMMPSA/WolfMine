...
class SortTask extends AsyncTask{
	private $player, $coinData, $addOp, $page, $ops, $banList;
	...
	private function getTopList(){
		...
		$n = 1;
		$this->max = ceil((count($coin) - count($banList) - ($this->addOp ? 0 : count($ops))) / 5);
