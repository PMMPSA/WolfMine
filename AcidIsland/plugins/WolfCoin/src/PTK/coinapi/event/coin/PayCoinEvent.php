...
class TraCoinEvent extends CoinEvent{
	private $payer, $target, $amount;
	public static $handlerList;
	
	public function __construct(Coin $plugin, $payer, $target, $amount){
		parent::__construct($plugin, "TraCommand");
