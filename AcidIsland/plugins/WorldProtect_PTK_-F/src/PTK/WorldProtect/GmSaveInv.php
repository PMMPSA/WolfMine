...
namespace PTK\WorldProtect;

use pocketmine\plugin\PluginBase as Plugin;
use pocketmine\event\Listener;
use pocketmine\item\Item;
use pocketmine\event\player\PlayeLOGModeChangeEvent;
use pocketmine\event\player\PlayerQuitEvent;
use pocketmine\event\player\PlayerDeathEvent;
use pocketmine\Player;

use PTK\WorldProtect\common\PluginCallbackTask;
...
class GmSaveInv extends BaseWp implements Listener {
    ...
    public function onGmChange(PlayeLOGModeChangeEvent $ev) {
        $player = $ev->getPlayer();
