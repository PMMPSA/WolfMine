...
class CustomEnchantCommand extends PluginCommand
{
    ...
    public function execute(CommandSender $sender,  $Label, array $args) : bool
    {
        ...
        if (count($args) < 1) {
            $sender->sendMessage(TextFormat::GOLD . "§a⬛⬛⬛⬛⬛⬛⬛§6 Enchant Nâng Cao§a ⬛⬛⬛⬛⬛⬛⬛\n\n§a•§b Để xem §adanh sách §bdùng lệnh§c /ce list\n§a•§b Để §anâng cấp§b item§6 dùng lệnh§c /ce enchant\n\n§a⬛⬛⬛⬛⬛⬛⬛§6 Enchant Nâng Cao§a ⬛⬛⬛⬛⬛⬛⬛");
            return false;
        }
