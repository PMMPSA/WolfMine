    ...
    public function onCommand(CommandSender $sender, Command $cmd, string $label, array $args) : bool{
        switch(strtolower($cmd->getName()))
        {
            ...
            case "settag":
                ...
                {
                    $sender->sendMessage(TextFormat::GREEN ."This command can be only used in-game.");
                ...
                if(!isset($args[0]))
                {
                    $sender->sendMessage(TextFormat::GREEN ." Usage: /settag <tag>");
                ...
                $sender->sendMessage(TextFormat::GREEN ."Your tag now is " . $prefix . "!");
