    ...
    */
    ...
    private function registerCommands()
    {
        ...
        if($this->getNoeulAPI()->isNoeulEnabled())
            $commandMap->register("ppsudo", new PPSudo($this, "ppsudo", $this->getMessage("cmds.ppsudo.desc") . ' '));
        $commandMap->register("addgroup", new AddGroup($this, "addgroup", $this->getMessage("cmds.addgroup.desc") . ' '));
		$commandMap->register("addparent", new AddParent($this, "addparent", $this->getMessage("cmds.addparent.desc") . ' '));
        ...
        $commandMap->register("grpinfo", new GrpInfo($this, "grpinfo", $this->getMessage("cmds.grpinfo.desc") . ' '));
        ...
        $commandMap->register("rmparent", new RmParent($this, "rmparent", $this->getMessage("cmds.rmparent.desc") . ' '));
